...
$stmt = $conn->prepare("SELECT t.id, u.username, t.jenis, t.jumlah, t.tanggal 
                        FROM transaksi t 
...
<head>
    ...
    <title>Rekap Transaksi Harian - Pengurus</title>
...
<div class="container-fluid p-0">
    <div class="row g-0">
        <nav class="col-md-2 sidebar p-3">
            ...
            <a href="rekap_transaksi.php" class="active"><i class="fas fa-chart-line"></i> Rekap Transaksi</a>
        ...
        <main class="col-md-10 content">
            <div class="d-flex justify-content-between align-items-center flex-wrap mb-4">
                <h2 class="page-title"><i class="fas fa-chart-bar me-2"></i> Rekap Transaksi Harian</h2>
                <div class="text-muted"><i class="fas fa-calendar-alt me-1"></i> <?php echo date('d F Y'); ?></div>
            </div>

            <div class="rekap-card">
                <div class="row g-4 mb-4">
                    <div class="col-md-4"><div class="summary-box"><h5><i class="fas fa-chart-line"></i> Total Transaksi</h5><p>Rp <?php echo number_format($total_transaksi,0,',','.'); ?></p></div></div>
                    <div class="col-md-4"><div class="summary-box"><h5><i class="fas fa-piggy-bank"></i> Simpanan</h5><p>Rp <?php echo number_format($total_simpanan,0,',','.'); ?></p></div></div>
                    <div class="col-md-4"><div class="summary-box"><h5><i class="fas fa-hand-holding-usd"></i> Pinjaman</h5><p>Rp <?php echo number_format($total_pinjaman,0,',','.'); ?></p></div></div>
                </div>

                <div class="table-responsive">
                    <table class="table table-custom table-hover align-middle">
                        <thead>
                            <tr><th>ID</th><th>Nama Siswa</th><th>Jenis</th><th>Jumlah (Rp)</th><th>Waktu</th></tr>
                        </thead>
                        <tbody>
                            <?php if (!empty($transaksi_list)): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($row['jenis'] == 'simpanan'): ?>
                                                <span class="badge-jenis badge-simpanan"><i class="fas fa-arrow-up"></i> Simpanan</span>
                                            <?php elseif ($row['jenis'] == 'pinjaman'): ?>
                                                <span class="badge-jenis badge-pinjaman"><i class="fas fa-arrow-down"></i> Pinjaman</span>
                                            <?php else: ?>
                                                <span class="badge-jenis bg-info"><?php echo ucfirst($row['jenis']); ?></span>
                                            <?php endif; ?>
                                        </td>
                                ...
                                <?php endforeach; ?>
                            <?php else: ?>
                                <tr><td colspan="5" class="text-center py-4 text-muted">Belum ada transaksi hari ini</td><?php endif; ?>
                        </tbody>
                    </table>
                </div>
            </div>
            <footer><i class="fas fa-chart-line"></i> Sistem Informasi Koperasi Sekolah | Rekap transaksi harian</footer>
        </main>
    </div>
</div>
